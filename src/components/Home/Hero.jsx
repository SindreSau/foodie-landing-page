  ...
  return (
    <>
      ...
      <div className='relative flex flex-col items-center py-8 md:py-24'>
        ...
        <div className='content-max-width flex flex-col justify-center px-1 items-center gap-5 md:gap-11'>
          <h3 className='ff-montserrat-700  md:text-2xl clr-grey md:text-white'>
            Food app
          </h3>
          <h1 className='md:ff-poppins-700 ff-montserrat-700 leading-5 md:text-6xl text-4xl text-center md:text-white clr-secondary'>
